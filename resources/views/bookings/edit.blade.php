@extends('layouts.app')
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Editar Conduce</h1>
            <!--end::Title-->
            <!--begin::Separator-->
...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <form action="{{ route('bookings.update', $booking->id) }}" id="frm-crud-update" method="post">
                @csrf
                @method('PUT')
                <!--begin::Card-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <select class="form-select form-select-solid" name="customer_id" id="customer_id" data-control="select2" data-placeholder="seleccionar item">
                                        ...
                                        @if(intval(auth::user()->customer_id) > 0)
                                            <option value="{{ auth::user()->customer->id }}" @if(auth::user()->customer->id == $booking->customer_id) selected="" @endif >{{ auth::user()->customer->name }}</option>
                                        @else
                            ...
                            <div class="d-flex flex-wrap gap-5 mb-4">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <select class="form-select form-select-solid" name="vehicle_id" id="vehicle_id" data-control="select2" data-placeholder="seleccionar item">
                                        ...
                                        <option value="{{ $vehicle->id }}" data-id="{{ $vehicle->id }}" data-outsource="{{ $vehicle->outsource }}"  @if($vehicle->id == $booking->vehicle_id) selected="" @endif >{{ $vehicle->name }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root outsource" style="display: {{ (@$booking->vehicle->outsource == 1) ? 'block' : 'none' }};">
                                    <!--begin::Label-->
                                    <label class="form-label" for="license_plate">Placa</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="license_plate" id="license_plate" value="{{ $booking->license_plate }}" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <select class="form-select form-select-solid" name="driver_id" id="driver_id" data-control="select2" data-placeholder="seleccionar item">
                                        ...
                                        <option value="{{ $driver->id }}" data-type="{{ $driver->driver_type }}" @if($driver->id == $booking->driver_id) selected="" @endif >{{ $driver->name }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root driver-outsource" style="display: {{ (@$booking->driver->driver_type == 'SUBCONTRATADO') ? 'block' : 'none' }}">
                                    <!--begin::Label-->
                                    ...
                                    <select class="form-select form-select-solid" name="subcontractor_id" id="subcontractor_id">
                                        ...
                                        <option value="{{ $driver->id }}" data-type="{{ $driver->driver_type }}" @if($driver->id == $booking->subcontractor_id) selected="" @endif  >{{ $driver->name }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
