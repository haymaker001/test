@extends('layouts.app')
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Listado de Conduces</h1>
            <!--end::Title-->
            <!--begin::Separator-->
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Listado de Conduces</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<div class="post d-flex flex-column-fluid" id="kt_post">
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <!--end::Export-->
                        <!--begin::Add customer-->
                        <a href="{{ route('bookings.create') }}" class="btn btn-primary">Agregar</a>
                        <!--end::Add customer-->
                    </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title">Confirmar Pago de Viaje</h3>
                        ...
                        <div class="modal-body">
                            <p>Estas seguro que deseas confirmar el pago de este viaje?</p>
                        </div>
            
                        <div class="modal-footer">
                            <form class="hidden" action="{{ route('bookings-confirm-payment') }}" method="post" id="frm-crud-payed">
                                @csrf
            ...
            <input type="hidden" name="pdf_url" id="pdf_url" value="{{ route('bookings.pdf', ':id') }}">
            <input type="hidden" name="search_url" id="search_url" value="{{ route('bookings.search') }}" />
            <input type="hidden" name="hidden_page" id="hidden_page" value="1" />

            <form class="hidden" action="{{ route('bookings.destroy', ':id') }}" method="post" id="frm-crud-destroy">
                @csrf
                @method('DELETE')
            </form>
            <!--end::Card body-->
