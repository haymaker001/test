@extends('layouts.app')
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Listado de Usuarios</h1>
            <!--end::Title-->
            <!--begin::Separator-->
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0" id="search-data-container">
                @include('dynamics/users')
            </div>

            <input type="hidden" name="search_url" id="search_url" value="{{ route('users.search') }}" />
            <input type="hidden" name="hidden_page" id="hidden_page" value="1" />

            <form class="hidden" action="{{ route('users.destroy', ':id') }}" method="post" id="frm-crud-destroy">
                @csrf
                @method('DELETE')
            </form>
            <!--end::Card body-->
