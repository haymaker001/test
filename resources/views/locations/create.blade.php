...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <form action="{{ route('locations.store') }}" id="frm-crud-add" method="post">
                @csrf
                <!--begin::Card-->
                        ...
                        <div class="card-body pt-0">
                            <div class="d-flex flex-wrap gap-5 mb-10">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="location" id="location" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <select class="form-select form-select-solid" name="location_type" id="location_type" data-control="select2" data-placeholder="seleccionar item">
                                        <option value="DT">Destinos</option>
                                        <option value="PD">Paradas / Adicionales</option>
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" class="form-control mb-2" name="destinations" id="destinations" value="1" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
