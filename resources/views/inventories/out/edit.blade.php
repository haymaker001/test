...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <form action="{{ route('inventories-out.update', $inventory->id) }}" id="frm-crud-update" method="post">
                @csrf
                @method('PUT')
                        ...
                        <div class="card-body pt-0">
                            <div class="d-flex flex-wrap gap-5 mb-10">
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <select class="form-select form-select-solid" name="item_definition_id" id="item_definition_id" data-control="select2" data-placeholder="seleccionar producto">
                                        ...
                                        <option @if($inventory->item_definition_id == $warehouse->id) selected="" @endif value="{{ $warehouse->id }}">{{ $warehouse->reference }} - {{ $warehouse->name }} - {{ $warehouse->brand }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <select class="form-select form-select-solid" name="warehouse_id" id="warehouse_id" data-control="select2" data-placeholder="seleccionar ubicación">
                                        ...
                                        <option value="{{ $warehouse->id }}" @if($inventory->warehouse_id == $warehouse->id) selected="" @endif >{{ $warehouse->name }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <select class="form-select form-select-solid" name="warehouse_location_id" id="warehouse_location_id" data-control="select2" data-placeholder="seleccionar ubicación">
                                        ...
                                        <option @if($inventory->warehouse_location_id == $warehouse->id) selected="" @endif value="{{ $warehouse->id }}">{{ $warehouse->name }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <select class="form-select form-select-solid" name="section_id" id="section_id" data-control="select2" data-placeholder="seleccionar ubicación">
                                        @foreach($inventory->warehouse_location->sections as $warehouse)
                                        <option value="{{ $warehouse->id }}" @if($inventory->section_id == $warehouse->id) selected="" @endif >{{ $warehouse->name }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                            ...
                            <div class="d-flex flex-wrap gap-5 mb-10">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <select class="form-select form-select-solid" name="vehicle_id" id="vehicle_id" data-control="select2" data-placeholder="seleccionar vehiculo">
                                        ...
                                        <option @if($inventory->vehicle_id == $warehouse->id) selected="" @endif value="{{ $warehouse->id }}">{{ $warehouse->name }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" class="form-control mb-2" name="pieces" id="pieces" value="{{ $inventory->pieces }}" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="price" id="price" value="{{ $inventory->price }}" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="hidden" class="form-control mb-2" name="technical" id="technical" value="{{ $inventory->technical }}" />
                                    <select class="form-select form-select-solid" name="technician_id" id="technician_id" data-control="select2" data-placeholder="seleccionar tecnico">
                                        ...
                                        <option @if($inventory->technician_id == $warehouse->id) selected="" @endif value="{{ $warehouse->id }}">{{ $warehouse->name }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                            ...
                            <div class="d-flex flex-wrap gap-5 mb-10">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="notes" id="notes" value="{{ $inventory->notes }}" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
