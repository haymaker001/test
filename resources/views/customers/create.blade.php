@extends('layouts.app')
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Crear Cliente</h1>
            <!--end::Title-->
            <!--begin::Separator-->
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted"><a href="{{ route('customers.index') }}">Listado de Cliente</a></li>
                <!--end::Item-->
                <!--begin::Item-->
...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <form action="{{ route('customers.store') }}" id="frm-crud-add" method="post">
                @csrf
                <!--begin::Card-->
                        ...
                        <div class="card-body pt-0">
                            <div class="d-flex flex-wrap gap-5 mb-10">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="rnc" id="rnc" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                            ...
                            <div class="d-flex flex-wrap gap-5 mb-10">
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="additional" id="additional" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="additional_outsource" id="additional_outsource" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="amount_outsource" id="amount_outsource" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">Monto a cobrar luego de la parada establecida.</div>
                                    <!--end::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <select class="form-select form-select-solid" name="calculation_type" id="calculation_type" data-control="select2" data-placeholder="seleccionar item">
                                        <option value="cantidad_destinos">Sumar cantidad de destinos</option>
                                        <option value="ruta_mas_larga" select="">Solo contabilizar ruta más larga</option>
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
