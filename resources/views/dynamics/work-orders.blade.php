                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Recogida</th>
                                <th class="min-w-125px">Equipo</th>
                                <th class="min-w-125px">Chofer</th>
                                <th class="min-w-125px">Rutas</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr id="{{ $booking->id }}" >
                                ...
                                <!--begin::Name=-->
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary mb-1">{{ $booking->number }}</a>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary mb-1">{{ $booking->pickup }}</a>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary mb-1">{{ $booking->locations ?? 'N/A' }}</a>
                                </td>
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary mb-1">{{ $booking->status ?? 'N/A' }}</a>
                                </td>
                                <td class="text-end">

                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        @if($booking->status == 'REGISTRADO')
                                        <a href="javascript:void(0)" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" onclick="triggerAssigment({{ $booking->id }})" data-bs-toggle="modal" data-bs-target="#kt_modal_1">
                                        ...
                                        @elseif($booking->status == 'ASIGNADO')
                                        <a href="javascript:void(0)" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" onclick="triggerConvert({{ $booking->id }})" data-bs-toggle="modal" data-bs-target="#kt_modal_2">
                                        ...
                                        @endif
                                        <a href="{{ route('work-orders.edit', $booking->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
