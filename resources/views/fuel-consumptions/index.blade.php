@extends('layouts.app')
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Listado de Registro de Combustible</h1>
            <!--end::Title-->
            <!--begin::Separator-->
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Listado de Registro de Combustible</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <!--end::Export-->
                        <!--begin::Add customer-->
                        <a href="{{ route('fuel-consumptions.create') }}" class="btn btn-primary">Agregar</a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
            ...
            <div class="card-body pt-0" id="search-data-container">
                @include('dynamics/fuel-consumptions')
            </div>

            <input type="hidden" name="search_url" id="search_url" value="{{ route('fuel-consumptions.search') }}" />
            <input type="hidden" name="hidden_page" id="hidden_page" value="1" />

            <form class="hidden" action="{{ route('fuel-consumptions.destroy', ':id') }}" method="post" id="frm-crud-destroy">
                @csrf
                @method('DELETE')
            </form>
            <!--end::Card body-->
