@extends('layouts.app')
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Crear Tarífa</h1>
            <!--end::Title-->
            <!--begin::Separator-->
...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <form action="{{ route('rates.store') }}" id="frm-crud-add" method="post">
                @csrf
                <!--begin::Card-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="d-flex flex-wrap gap-5 mb-10">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="rate" id="rate" value="0" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="rate_outsource" id="rate_outsource" value="0" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
...
<script>
    function AbstractCrudAdd(){
        ...
        $("#travel_type_id").val('1').trigger('change');
    }
</script>
@endsection